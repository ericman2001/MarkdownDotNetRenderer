...
`build/verify.{sh,ps1}` is the definition of a green build; `.github/workflows/ci.yml` runs that
same script on all three OSes and contains no build logic of its own
