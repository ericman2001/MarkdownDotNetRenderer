...
/// layout. Both ends of a relationship carry a glyph, which is why the shared edge painter draws a
/// glyph at either end.
/// </summary>
        ...
        LayoutMetrics metrics)
    {
        ...
        foreach (ErRelationship relationship in model.Relationships)
        {
            ...
            edges.Add(new GraphEdgeSpec(
                ...
                GraphMarkers.EndpointInset(start, theme.Edge.MarkerSize, theme.Edge.StrokeWidth),
                GraphMarkers.EndpointInset(end, theme.Edge.MarkerSize, theme.Edge.StrokeWidth)));
        }
        ...
        return new ErLayoutResult(
            true, new ErDiagramLayout(boxes, placement.Placement), null);
    }
